...
class Board:
    ...
    def make_new_board(self) -> list[list]:
    ...
    def get_num_neighboring_bombs(self, row, col):
        ...
        # EXAMPLE : if we have a middle element
    ...
    def dig(self, row, col):
        # if row < 0 or row >= self.dim_size or col < 0 or col >= self.dim:
        #     return False
    ...
    def __str__(self):
        """
        IF WE RUN print(BOARD instance) ?
        It is going to print what is defined here
        """
